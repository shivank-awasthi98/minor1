...
<html>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom shadow">
            <div class="container">
               ...
               <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <li class="nav-item ">
                        <div class="dropdown" style="a:hover{color:#ffc107}"><a class="nav-link dropdown" href="#" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Jobs</a>
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item disabled" href="#">All job</a>
                      ...
                      <li class="nav-item">
                        <div class="dropdown"><a class="nav-link" href="#" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Freelancers</a>
                              ...
                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <a class="dropdown-item disabled" href="searchparttimer.php">Search parttimer</a>
                    ...
                    <a href="landing.php?logout=1" class="btn btn-warning my-2 my-sm-0 rounded-pill" type="submit" id="logout">Logout</a>
        ...
        <div class="container">
            ...
            <div class='row'>
            <input class='rounded-pill form-control border border-warning shadow bg-white' placeholder='Search your Partimer...' id='stb' type="text" autocomplete="off">
            </div>
            <div class='row'>
            <button class='btn btn-warning rounded-pill text-white' id="sb" type="submit">Find</button>
